...
const skills = [
  {
    ...
    tech: "React.js, Next.js, Flutter",
    description: "Building responsive and interactive user interfaces with modern web and mobile technologies.",
    color: "text-blue-500",
  },
  {
    icon: Server,
  ...
  },
  {
    ...
    description: "Developing cross-platform mobile applications with native-like performance and user experience.",
    color: "text-pink-500",
  },
  {
    icon: GitBranch,
  ...
  },
  {
    ...
    tech: "Python, C++, JavaScript, TypeScript",
  ...
  },
  {
    ...
    tech: "Appium, OpenCV, Python",
    description: "Creating automated testing frameworks for Android applications with image recognition capabilities.",
    color: "text-cyan-500",
  },
]
